...
from Converters import getGoldTruthTest,getGoldTruthTrain,getIndexes,getRelations
from KerasTextClassifier import KerasTextClassifier
...
if __name__ == '__main__':
         ...
         gold_truths_train,tr_tr,ts_tr = getGoldTruthTrain(relations_train,documents_train)
		...
		predicted_tags=[]
                with open('relation_classifier_test.csv', 'w', newline='') as file:
                           ...
                           for sentenceID in range(0,288):
							...
							actual_tags.append(getGoldTruthTest(sentenceID,gold_truth_indexes[i]))
